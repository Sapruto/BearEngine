...
void InitUI(UIRendering* uiRenderer, ResourceManager& resources) {
    ...
    background->rectTransform->SetSizeDelta(Vector2f(1920, 1080));
    ...
    logo->SetLayer(1);
    logo->rectTransform->SetAnchorMin(Vector2f(0, 0));
    logo->rectTransform->SetAnchorMax(Vector2f(0, 0));
    logo->rectTransform->SetAnchoredPosition(Vector2f(100, 100));
    logo->rectTransform->SetSizeDelta(Vector2f(256, 256));
    ...
    button->SetLayer(2);
    button->rectTransform->SetAnchorMin(Vector2f(0, 0));
    button->rectTransform->SetAnchorMax(Vector2f(0, 0));
    button->rectTransform->SetAnchoredPosition(Vector2f(800, 500));
    button->rectTransform->SetSizeDelta(Vector2f(200, 80));
    ...
    title->SetLayer(3);
    title->rectTransform->SetAnchorMin(Vector2f(0, 0));
    title->rectTransform->SetAnchorMax(Vector2f(0, 0));
    title->rectTransform->SetAnchoredPosition(Vector2f(400, 50));
    ...
    subtitle->SetLayer(3);
    subtitle->rectTransform->SetAnchorMin(Vector2f(0, 0));
    subtitle->rectTransform->SetAnchorMax(Vector2f(0, 0));
    subtitle->rectTransform->SetAnchoredPosition(Vector2f(450, 120));
    ...
    buttonText->rectTransform->SetAnchorMin(Vector2f(0, 0));
    buttonText->rectTransform->SetAnchorMax(Vector2f(0, 0));
    buttonText->rectTransform->SetAnchoredPosition(Vector2f(860, 520));
    ...
    info->SetLayer(4);
    info->rectTransform->SetAnchorMin(Vector2f(0, 0));
    info->rectTransform->SetAnchorMax(Vector2f(0, 0));
    info->rectTransform->SetAnchoredPosition(Vector2f(50, 1000));
    info->SetColor(glm::vec4(0.5f, 0.5f, 0.5f, 1.0f));
    uiCanvas->AddUIElement(info);*/

    title->rectTransform->SetSizeDelta(Vector2f(800, 100));
...
int main() {
    ...
    playerTransform->position = Vector3f(0, 2, 0);
    playerTransform->scale = Vector3f(0.8f, 1.2f, 0.8f);
    ...
    groundTrans->position = Vector3f(0, -1, 0);
    groundTrans->scale = Vector3f(30, 1, 30);
    ...
    for (size_t i = 0; i < platformPositions.size(); i++) {
        ...
        platTrans->scale = Vector3f(2, 0.5f, 2);
    ...
    for (const auto& pos : coinPositions) {
        ...
        coinTrans->scale = Vector3f(0.5f, 0.5f, 0.5f);
    ...
    while (!window->ShouldClose()) {
        ...
        if (impulse) {
            ...
            if (input.GetKeyDown(Keys::Space)) {
                ...
                if (onGround) {
                    impulse->AddForce(Vector3f(0, 8, 0), 15.0f);
                }
            }
        }
        ...
        Vector3f targetPos = playerTransform->position + Vector3f(0, 5, 10);
