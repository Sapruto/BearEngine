...
RectTransform::RectTransform() : 
    anchoredPosition("anchoredPosition", Vector2f(0, 0)),
    sizeDelta("sizeDelta", Vector2f(100, 100)),
    pivot("pivot", Vector2f(0.5f, 0.5f)),
    anchorMin("anchorMin", Vector2f(0.5f, 0.5f)),
    anchorMax("anchorMax", Vector2f(0.5f, 0.5f)),
    rotation("rotation", 0.0f),
    parent(nullptr) {
}

void RectTransform::SetAnchors(Vector2f anchorMin, Vector2f anchorMax) {
