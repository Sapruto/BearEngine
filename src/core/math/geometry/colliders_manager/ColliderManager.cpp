...
void ColliderManager::CheckPair(Collider* a, Collider* b) {
...
std::vector<Collider*> ColliderManager::GetCollisionsFor(Collider* collider) const {
...
bool ColliderManager::AreColliding(const Collider* a, const Collider* b) const {
